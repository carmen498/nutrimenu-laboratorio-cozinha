      ...
      <DialogContent className="max-w-lg">
        ...
        {!result ? (
          ...
          <div className="space-y-3">
              ...
              <div>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <p className="text-sm font-semibold text-red-700">
                    Ingredientes não encontrados ({result.naoEncontrados.length})
                  </p>
                </div>
                  ...
                  <table className="w-full text-xs">
                    <thead className="bg-muted sticky top-0">
                      <tr>
                        ...
                        <th className="text-left p-2">Ingrediente (não encontrado)</th>
            ...
            {result.naoEncontrados.length === 0 && (
              <p className="text-xs text-muted-foreground">Todos os ingredientes foram encontrados.</p>
            )}
