...
const FAQ = [
  ...
  { q: "Funciona para quem tem cozinheira em casa?", a: "Sim. Você monta o cardápio da semana e entrega o plano pronto: ficha de produção, lista de receitas na ordem do dia e lista de compras. Menos WhatsApp, menos improviso." },
