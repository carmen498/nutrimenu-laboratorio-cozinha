    ...
    <div className="space-y-5 pb-24 md:pb-8 max-w-6xl mx-auto">
      ...
      <div className="grid lg:grid-cols-[1fr_320px] gap-5 items-start">
        ...
        <div className="space-y-4 lg:sticky lg:top-20">
          <Card className="p-5">
            <div><p className="text-xs font-semibold text-primary">RESULTADO</p><div className="flex items-center gap-2 mt-0.5"><Settings2 className="w-5 h-5 text-primary" /><h2 className="font-semibold">Resultado do rateio</h2></div></div>
