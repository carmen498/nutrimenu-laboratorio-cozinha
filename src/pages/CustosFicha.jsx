...
export default function CustosFicha() {
  ...
  const lucroUnitario = preco - Number(calculo?.custo_unitario || 0);
  ...
  return (
    <div className="space-y-5 pb-24 md:pb-8 max-w-6xl mx-auto">
      ...
      <div className="grid sm:grid-cols-2 xl:grid-cols-4 gap-3">
        ...
        <Card className="p-4"><p className="text-xs text-muted-foreground">Margem estimada</p><p className="text-2xl font-bold mt-1">{preco > 0 ? pct(calculo.margem_estimada) : "—"}</p><p className="text-[11px] text-muted-foreground mt-1">sobre o preço de venda</p></Card>
      </div>
      ...
      <div className="grid lg:grid-cols-[1.25fr_.75fr] gap-4 items-start">
        ...
        <Card className="p-5">
          ...
          <div className="space-y-3 mt-4 text-sm"><div className="flex justify-between"><span className="text-muted-foreground">Preço informado</span><strong>{preco > 0 ? money(preco) : "—"}</strong></div><div className="flex justify-between"><span className="text-muted-foreground">Custo por unidade</span><strong>{money(calculo.custo_unitario)}</strong></div><div className="flex justify-between"><span className="text-muted-foreground">Lucro estimado por unidade</span><strong>{preco > 0 ? money(lucroUnitario) : "—"}</strong></div><div className="flex justify-between"><span className="text-muted-foreground">Margem</span><strong>{preco > 0 ? pct(calculo.margem_estimada) : "—"}</strong></div></div>
