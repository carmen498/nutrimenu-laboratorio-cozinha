...
// Usa SOMENTE os valores BASE já calculados por montarFichaTecnica — não recalcula nada
// e não altera nenhum indicador, cálculo ou estrutura já validada da ficha/PDF.
...
export function montarTextoCompartilhamentoFicha({ receita, ficha, passos }) {
  ...
  text += `Rendimento (PDP): ${formatKg(ficha.rendimentoTotal)} · ${ficha.nPorcoes} porções\n`;
